...
urlpatterns = [
    ...
    path('api/v1/<str:username>/posts/', views.UserPostView.as_view(), name="userposts"),
    ...
    path('api/v1/posts/<str:post_id>/photos/<str:photo_id>/like/', views.PhotoLikeView.as_view()),
